...
public class MainActivity extends AppCompatActivity {
    ...
    protected TextView standarWeight;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        standarWeight=(TextView)findViewById(R.id.standardWeight);
    ...
    private void runAsyncTask(){
        new AsyncTask<Void, Integer, Boolean>() {
            ...
            protected void onPostExecute(Boolean status){
                ...
                double cal_BodyEat = 0;
                if (gender==1){
                    cal_StandWeight=22*cal_Tall/100*cal_Tall/100;
                    cal_BodyEat=(cal_Weight-(0.88*cal_StandWeight))/cal_Weight*100;
                }
                if (gender==2){
                    cal_StandWeight=22*cal_Tall/100*cal_Tall/100;
                    cal_BodyEat=(cal_Weight-(0.82*cal_StandWeight))/cal_Weight*100;
                }
                standarWeight.setText(String.format("%.2f",cal_StandWeight));
                bodyFat.setText(String.format("%.2f",cal_BodyEat));
            }
        } .execute();
    }
}
